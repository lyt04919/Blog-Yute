	...
	return (
		<div className='grid grid-cols-2 gap-4'>
			<div>
				...
				<div className='group relative h-20 w-20 cursor-pointer overflow-hidden rounded-lg border bg-white dark:bg-[#27272a]/60'>
			...
			<div>
				...
				<div className='group relative h-20 w-20 cursor-pointer overflow-hidden rounded-full border bg-white dark:bg-[#27272a]/60'>
