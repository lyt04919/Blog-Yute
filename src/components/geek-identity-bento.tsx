							...
							<Marquee pauseOnHover duration="18s" className="py-2">
								{files.map((file, idx) => {
									...
									return (
										<div
											key={idx}
											className="w-28 h-34 rounded-xl bg-zinc-50 dark:bg-zinc-800/90 border border-zinc-200/90 dark:border-zinc-700/80 p-3 shadow-md flex flex-col justify-between shrink-0 select-none transition-all duration-300 hover:scale-105 hover:shadow-lg"
										>
