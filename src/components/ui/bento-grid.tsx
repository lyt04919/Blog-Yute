...
export function BentoCard({
  ...
  return (
    <div
      ...
      {...props}
    >
      <div className="relative w-full h-[55%] overflow-hidden">{background}</div>
      ...
      {cta && (
        <div
          className={cn(
            "pointer-events-none flex w-full translate-y-0 transform-gpu flex-row items-center transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100 lg:hidden px-6 pb-6"
          )}
        >
          <a
            href={href || "#"}
